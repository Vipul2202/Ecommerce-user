      ...
      <div className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <p className="text-orange-400 text-lg font-semibold tracking-wider uppercase">
          ...
          <div className="space-y-12">
            ...
            <section>
              <h2 className="text-2xl font-bold text-orange-400 mb-6">1. Information We Collect</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-orange-400 mb-6">2. How We Use Your Information</h2>
              <ul className="space-y-4 text-gray-300">
                <li className="flex items-start">
                  <span className="text-orange-400 mr-3 mt-1">•</span>
            ...
            <section>
              <h2 className="text-2xl font-bold text-orange-400 mb-6">3. Sharing Your Information</h2>
              <ul className="space-y-4 text-gray-300">
                <li className="flex items-start">
                  <span className="text-orange-400 mr-3 mt-1">•</span>
            ...
            {/* 4. Data Security */}
            <section>
              <h2 className="text-2xl font-bold text-orange-400 mb-6">4. Data Security</h2>
              <ul className="space-y-4 text-gray-300">
                <li className="flex items-start">
                  <span className="text-orange-400 mr-3 mt-1">•</span>
            ...
            <section>
              <h2 className="text-2xl font-bold text-orange-400 mb-6">5. Your Rights and Choices</h2>
              <ul className="space-y-4 text-gray-300">
                <li className="flex items-start">
                  <span className="text-orange-400 mr-3 mt-1">•</span>
                  <span>You may access, update, or delete your personal information by contacting us at <a href="mailto:info@carsaloon.com.au" className="text-orange-400 hover:text-orange-300 underline">info@carsaloon.com.au</a>.</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-400 mr-3 mt-1">•</span>
            ...
            {/* 6. Third-Party Links */}
            <section>
              <h2 className="text-2xl font-bold text-orange-400 mb-6">6. Third-Party Links</h2>
              <ul className="space-y-4 text-gray-300">
                <li className="flex items-start">
                  <span className="text-orange-400 mr-3 mt-1">•</span>
            ...
            <section>
              <h2 className="text-2xl font-bold text-orange-400 mb-6">7. Changes to This Privacy Policy</h2>
              <ul className="space-y-4 text-gray-300">
                <li className="flex items-start">
                  <span className="text-orange-400 mr-3 mt-1">•</span>
            ...
            {/* 8. Contact Us */}
            <section>
              <h2 className="text-2xl font-bold text-orange-400 mb-6">8. Contact Us</h2>
              <ul className="space-y-4 text-gray-300">
                <li className="flex items-start">
                  <span className="text-orange-400 mr-3 mt-1">•</span>
                  <span>If you have any questions or concerns about this Privacy Policy, please contact us at <a href="mailto:info@carsaloon.com.au" className="text-orange-400 hover:text-orange-300 underline">info@carsaloon.com.au</a>.</span>
                </li>
              </ul>
            </section>
      ...
      <div className="bg-gradient-to-r from-orange-600 to-orange-500 py-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a 
            ...
            className="inline-block bg-white text-orange-600 font-semibold px-8 py-3 rounded-lg hover:bg-gray-100 transition-colors duration-300"
          >
            Contact Us
          </a>
        </div>
