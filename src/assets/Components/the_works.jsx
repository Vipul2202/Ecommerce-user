  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Header */}
        ...
        <p className="text-gray-600 text-lg mb-4">Best for Offroad and Pre-Sale</p>
              ...
              <div className="mb-10">
                ...
                <ul className="space-y-2">
                  <li className="flex items-center">
                   <span className="w-4 h-4 text-white  bg-black mr-2 flex items-center justify-center rounded-sm text-xs font-bol"> ✓</span>Includes Signature Detail Plus
                  </li>
                  <li className="flex items-center">
                   <span className="w-4 h-4 text-white  bg-black mr-2 flex items-center justify-center rounded-sm text-xs font-bol"> ✓</span> Buff and Polish
                  </li>
                  <li className="flex items-center">
                   <span className="w-4 h-4 text-white  bg-black mr-2 flex items-center justify-center rounded-sm text-xs font-bol"> ✓</span> Underbody Clean (Using Ramp)
                  </li>
                </ul>
              </div>

              <div className="mb-6">
                <h2 className="text-lg font-semibold mb-2 text-black">BUFF AND POLISH</h2>
                <p className="text-sm leading-relaxed">
                  We machine buff and polish the paintwork to remove light scratches and swirl marks, restoring depth and clarity to the finish. The result is a smooth, reflective surface that brings the paint back to life.
                </p>
              </div>
              <div className="mb-6">
                <h2 className="text-lg font-semibold mb-2 text-black">UNDERBODY CLEAN (USING RAMP)</h2>
                <p className="text-sm leading-relaxed">
                  Your car is raised on a ramp so we can thoroughly wash away mud, dirt, and grime built up underneath. Essential after off-road driving and a must before any pre-sale inspection.
                </p>
              </div>
